...
#define REALSENSE_ROS_VERSION_STR                                           \
    (VAR_ARG_STRING(REALSENSE_ROS_MAJOR_VERSION.REALSENSE_ROS_MINOR_VERSION \
...
const std::string DEFAULT_BASE_FRAME_ID = "world";
const std::string DEFAULT_IMU_OPTICAL_FRAME_ID = "world";
