...
configurable_parameters = [{'name': 'camera_name',                  'default': 'camera', 'description': 'camera unique name'},
                           ...
                           {'name': 'color_camera.image_transport','default': 'compressed', 'description': 'enable color stream'},
                           ...
                           {'name': 'base_frame_id',                'default': 'world', 'description': 'Root frame of the sensors transform tree'},
